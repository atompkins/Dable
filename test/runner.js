...
(function() {
  ...
  if (args.length < 4) {
    console.error('Usage:\n  phantomjs [phantom arguments] runner.js ' +
      '[url-of-your-qunit-testsuite] [timeout-in-seconds] [coverageLocation]');
    exit(1);
  }
  ...
  if (typeof args[3] !== 'undefined') {
    try {
      ...
      if (pageProperties && pageProperties.coverageLocation) {
        coverageLocation = pageProperties.coverageLocation;
      }
    } catch (e) {
